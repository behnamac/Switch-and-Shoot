...
//			_light.renderMode = LightRenderMode.ForcePixel;
		...
		if(lightType == LightType.Indicator){
			...
			if(!carController.transform.Find("All Audio Sources/Indicator Sound AudioSource"))
				indicatorSound = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, carController.gameObject, "Indicator Sound AudioSource", 1f, 3f, 1, indicatorClip, false, false, false);
			else
