...
//		GetComponentInChildren<WheelCollider>().ConfigureVehicleSubsteps(10f, 1, 1);
	...
	void SoundsInitialize (){
		...
		case AudioType.OneSource:
			...
			engineSoundHigh = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound High AudioSource", 5, 50, 0, engineClipHigh, true, true, false);

			if (autoCreateEngineOffSounds) {

				engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHigh, true, true, false);

				RCC_CreateAudioSource.NewLowPassFilter (engineSoundHighOff, 3000f);

			} else {

				engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHighOff, true, true, false);
		...
		case AudioType.TwoSource:
			...
			engineSoundHigh = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound High AudioSource", 5, 50, 0, engineClipHigh, true, true, false);
			engineSoundLow = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound Low AudioSource", 5, 25, 0, engineClipLow, true, true, false);

			if (autoCreateEngineOffSounds) {

				engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHigh, true, true, false);
				engineSoundLowOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound Low Off AudioSource", 5, 25, 0, engineClipLow, true, true, false);
				...
				engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHighOff, true, true, false);
				engineSoundLowOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound Low Off AudioSource", 5, 25, 0, engineClipLowOff, true, true, false);
		...
		case AudioType.ThreeSource:
			...
			engineSoundHigh = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound High AudioSource", 5, 50, 0, engineClipHigh, true, true, false);
			engineSoundMed = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound Medium AudioSource", 5, 50, 0, engineClipMed, true, true, false);
			engineSoundLow = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound Low AudioSource", 5, 25, 0, engineClipLow, true, true, false);

			if (autoCreateEngineOffSounds) {

				engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHigh, true, true, false);
				engineSoundMedOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound Medium Off AudioSource", 5, 50, 0, engineClipMed, true, true, false);
				engineSoundLowOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound Low Off AudioSource", 5, 25, 0, engineClipLow, true, true, false);
				...
				engineSoundHighOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound High Off AudioSource", 5, 50, 0, engineClipHighOff, true, true, false);
				engineSoundMedOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound Medium Off AudioSource", 5, 50, 0, engineClipMedOff, true, true, false);
				engineSoundLowOff = RCC_CreateAudioSource.NewAudioSource (RCCSettings.mixer, gameObject, "Engine Sound Low Off AudioSource", 5, 25, 0, engineClipLowOff, true, true, false);
		...
		engineSoundIdle = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "Engine Sound Idle AudioSource", 5, 25, 0, engineClipIdle, true, true, false);
		reversingSound = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "Reverse Sound AudioSource", 1, 10, 0, reversingClip, true, false, false);
		windSound = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "Wind Sound AudioSource", 1, 10, 0, windClip, true, true, false);
		brakeSound = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "Brake Sound AudioSource", 1, 10, 0, brakeClip, true, true, false);
		hornSound = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "Horn/Siren Sound AudioSource", 0, 0, 1, PlayerPrefsX.GetBool(transform.name + "SirenAttached", false) ? sirenClip : hornClip, true, false, false);

		if(useNOS)
			NOSSound = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "NOS Sound AudioSource", 5, 10, 1f, NOSClip, true, false, false);
		if(useNOS || useTurbo)
			blowSound = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "NOS Blow", 1, 10, 1, null, false, false, false);
		if(useTurbo){
			turboSound = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "Turbo Sound AudioSource", .1f, .5f, 0, turboClip, true, true, false);
	...
	public IEnumerator StartEngineDelayed (){
		...
		engineRunning = false;
		engineStartSound = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "Engine Start AudioSource", 5, 10, 1, engineStartClip, false, true, true);
...
//			handbrakeInput = 1f;
	...
	public void SetGasInput(float value) => gasInput = value;
	public void SetBrakeInput(float value) => brakeInput = value;
	public void SetHandbrakeInput(float value) => handbrakeInput = value;
	public void SetSteerInput(float value) => steerInput = value;
	public void SetBoostInput(float value) => boostInput = value;
	public void SetLowBeamHeadLightsOn(bool value) => lowBeamHeadLightsOn = value;
	public void SetHighBeamHeadLightsOn(bool value) => highBeamHeadLightsOn = value;
	void Inputs()
	{
		...
		switch (RCCSettings.controllerType)
		{
			...
			case RCC_Settings.ControllerType.Keyboard:
				...
				SetGasInput(Input.GetAxis(RCCSettings.verticalInput));
				SetBrakeInput(Mathf.Clamp01(-Input.GetAxis(RCCSettings.verticalInput)));
				SetHandbrakeInput(Input.GetKey(RCCSettings.handbrakeKB) ? 1f : 0f);
				SetSteerInput(Input.GetAxis(RCCSettings.horizontalInput));
				SetBoostInput(Input.GetKey(RCCSettings.boostKB) ? 2.5f : 1f);

				if (Input.GetKeyDown(RCCSettings.lowBeamHeadlightsKB))
				{
					//lowBeamHeadLightsOn = !lowBeamHeadLightsOn;
					SetLowBeamHeadLightsOn(!lowBeamHeadLightsOn);
				}

				if (Input.GetKeyDown(RCCSettings.highBeamHeadlightsKB))
				{
					SetHighBeamHeadLightsOn(true);
					//highBeamHeadLightsOn = true;
				}
				else if (Input.GetKeyUp(RCCSettings.highBeamHeadlightsKB))
				{
					SetHighBeamHeadLightsOn(false);
	...
	public IEnumerator ChangeGear(int gear){
		...
		if(gearShiftingClips.Length > 0){
			...
			gearShiftingSound = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "Gear Shifting AudioSource", 0f, .5f, RCCSettings.maxGearShiftingSoundVolume, gearShiftingClips[UnityEngine.Random.Range(0, gearShiftingClips.Length)], false, true, true);
			...
			if (((1 << collision.gameObject.layer) & damageFilter) != 0) {
				...
				if(crashClips.Length > 0){
					...
					if (collision.contacts[0].thisCollider.gameObject.transform != transform.parent){
						...
						crashSound = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "Crash Sound AudioSource", 5, 20, RCCSettings.maxCrashSoundVolume, crashClips[UnityEngine.Random.Range(0, crashClips.Length)], false, true, true);
