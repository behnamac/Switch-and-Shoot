...
public class RCC_Exhaust : MonoBehaviour {
	...
	void Start () {
		...
		if(flame){
			...
			flameSource = RCC_CreateAudioSource.NewAudioSource(RCCSettings.mixer, gameObject, "Exhaust Flame AudioSource", 10f, 25f, 1f, RCCSettings.exhaustFlameClips[0], false, false, false);
